...
if (fs::file_exists(nuts_zip_path)==FALSE) {
  download.file(url = "https://gisco-services.ec.europa.eu/distribution/v2/nuts/download/ref-nuts-2024-20m.geojson.zip", destfile = nuts_zip_path)
...
nuts_countries_v <- nuts2_2024_sf |> 
  sf::st_drop_geometry() |> 
